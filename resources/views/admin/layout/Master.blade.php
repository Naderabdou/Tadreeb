                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li><a href="#"><i class="icon-cog5"></i> Account settings</a></li>
                        ...
                        <li>
                            ...
                            <a href="{{route('logout.admin')}}"><i class="icon-switch2"></i> Logout</a>
                ...
                <div class="sidebar-category sidebar-category-visible">
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li>
                                <a href=""><i class="fa fa-user"></i> <span>المتدربين</span></a>
                                <ul>
                                    <li><a href="{{route('admin.student.index')}}">عرض كل المتدربين</a></li>
                                    <li><a href="{{route('admin.student.create')}}">إنشاء متدرب</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href=""><i class="fa fa-user"></i> <span>المدربين</span></a>
                                <ul>
                                    <li><a href="{{route('admin.instructor.index')}}">عرض كل المدربين</a></li>
                                    <li><a href="{{route('admin.instructor.create')}}">إنشاء مدرب</a></li>
                                </ul>

                            <!-- /page kits -->
                            </li>
                            <li>
                                <a href=""><i class="fa fa-user"></i> <span>الدورة</span></a>
                                <ul>
                                    <li><a href="{{route('admin.course.index')}}">عرض كل الدورة</a></li>
                                    <li><a href="{{route('admin.course.create')}}">إنشاء دورة</a></li>
                                </ul>

                                <!-- /page kits -->
                            </li>
                            <li>
                                <a href=""><i class="fa fa-user"></i> <span>الاهتمامات</span></a>
                                <ul>
                                    <li><a href="{{route('admin.scope.index')}}">عرض كل الاهتمامات</a></li>
                                </ul>
